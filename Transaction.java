...
public class Transaction {
	...
	// making the private constructor to convert to singleton
	    ...
	    //Method to save transaction details in a .txt file to maintain a record.
	    public void saveTransaction(String transactionDetails)
	    {
	    	try
	    	{
	    	FileWriter write = new FileWriter("transactions.txt",true); //created an instance of FileWriter class that is assigned to a .txt file
	    	BufferedWriter bufferedWriter=new BufferedWriter(write);
	    	bufferedWriter.write(transactionDetails);
	    	bufferedWriter.newLine();
	    	bufferedWriter.close();
	    	}
	    	catch (IOException e) // handling exception in case there is some error in writing the file.
	    	{
